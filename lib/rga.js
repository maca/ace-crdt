...
RGA.AceEditorRGA = function AceEditorRGA(id, editor) {
  ...
  const contentChanged = ({ action, start, end, lines }) => {
    ...
    console.log('contentChanged', action, lines)
  ...
  const cursorChanged = () => {
    ...
    console.log('cursorChanged - node selection start', startNode && startNode.chr)
    console.log('cursorChanged - node selection end', endNode && endNode.chr)
